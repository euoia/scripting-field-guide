...
* Introduction
  ...
  I'm learning as I go. I just write MY current "state of the
...
*** grep -Fvf
    ...
    =-f= list of patterns to match as a file.
    ...
    list". So you can do list diffing. like =sort + diff= but more
    flexible.
...
** Some extra shortcuts for nice things
   ...
   - =alt-#= comment and accept. Nice way to store the current line
     for later.
...
* links
  ...
  - [[https://github.com/spencertipping/][spencertipping@github]]. This guy has some really sick snippets
...
* Footnotes
[fn:1] https://gist.github.com/samth/3083053
